...
#             <p style="color:#64748b; margin:10px 0; ">Code : <span style="background:#E0E3FF; padding:2px 8px; border-radius:5px">{code}</span>| Section : {section}</p>
#             """
#     if stats: 
#         html+="""
...
def subject_card(name, code, section, stats=None, footer_callback=None):
    ...
    # FIX: Close the main outer div container!
    html += "</div>"
